  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-fg">Departments</h2>
          <p className="text-sm text-fg-muted mt-1">Manage product departments</p>
        </div>
              ...
              {loading ? (
                ...
                departments.map((dept) => (
                  <TableRow key={dept.id}>
                    <TableCell className="font-medium text-fg">{dept.name}</TableCell>
                    <TableCell className="text-fg-muted">{dept.description || '—'}</TableCell>
                    <TableCell>
