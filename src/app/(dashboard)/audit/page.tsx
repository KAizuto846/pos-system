            ...
            {loading ? (
              ...
              logs.map((log) => {
                ...
                return (
                  <TableRow
                    key={log.id}
                    className="cursor-pointer border-line/60 align-top hover:bg-surface-2/40"
                  ...
                  >
                    ...
                    <TableCell className="max-w-xs text-sm text-fg-muted">
                      <p className="truncate">{log.description}</p>
                      {expanded === log.id && (
                        <p className="mt-1 break-words border-t border-line pt-1 text-xs text-fg-muted">
