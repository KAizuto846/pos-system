...
export async function POST(
  ...
  try {
    ...
    void logAudit({
      ...
      details: {
        cambios: { stock: { antes: result.updated.stock - quantity, despues: result.updated.stock } },
        ajuste: quantity,
      },
      before: { stock: result.updated.stock - quantity },
      after: { stock: result.updated.stock },
